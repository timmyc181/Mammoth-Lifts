...
@Model public class Workout {
    ...
    init(competionTimeSeconds: Int16? = nil, date: Date? = nil, increment: Float? = nil, restTimeSeconds: Int16? = nil, targetSets: Int16? = nil, exercise: Exercise? = nil, sets: [Set]? = nil) {
